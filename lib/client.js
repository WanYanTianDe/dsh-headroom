...
if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=\"@dsh-external/dsh-headroom/HeadroomCard.module.css\"]") === null) {
	const tag = document.createElement("style");
	tag.dataset.plugin = "@dsh-external/dsh-headroom";
	tag.dataset.pluginCss = "@dsh-external/dsh-headroom/HeadroomCard.module.css";
	tag.textContent = css;
